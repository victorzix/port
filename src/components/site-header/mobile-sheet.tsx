        ...
        {items.map((label, index) => {
          ...
          return (
            <a
              ...
              className="flex items-baseline gap-3 py-2.5 text-foreground transition-colors hover:text-brand active:text-brand aria-disabled:pointer-events-none aria-disabled:opacity-[0.38]"
            >
